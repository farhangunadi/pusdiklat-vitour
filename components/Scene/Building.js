...
import { GdKenyamanan } from '../Asset Environment/Gedungkenyamanan';
import { JogloLowPoly } from '../Asset Environment/JogloLowPolyNew';
...
export const Building = () => {
  return (
    <group>
        ...
        <JogloLowPoly position={[140,0,-28.1]} scale={0.3} />
        ...
        <GdKenyamanan position={[43,-0.5,-26]} scale={2} />
        {/* <Info /> */}
        ...
        <Info position={[129,0,-53]} positionInfo={[129,2.5,-53]}  scale={0.5} info="Wisma Lodaya" />
        <Info position={[170,0,-37]} positionInfo={[170,2.5,-37]}  scale={0.5} info="Wisma Dormitory" />
        <Info position={[169,0,-13]} positionInfo={[169,2.5,-13]} scale={0.5} info="Wisma Parahyangan" />
        <Info position={[141,0,2]} positionInfo={[141,2.5,2]} scale={0.5} info="Wisma Turangga" />
        <Info position={[117.7,0,2]} positionInfo={[117.7,2.5,2]} scale={0.5} info="Wisma Harina" />
        <Info position={[52,0,-26]} positionInfo={[52,2.5,-26]} scale={0.5} info="Gedung Kenyamanan" />
    </group>
  )
}
